...
PARTNERS = [
    ...
    "url":"https://galaxy-esolutions.com/",
     "desc":lazy_gettext("Galaxy eSolutions is disrupting the multi-billion dollar refurbished electronics and smartphone industry with its comprehensive platform built on Origin Protocol.")
    },
    {
    "name":"thrivelabs",
    "url":"https://www.ico.thrivelabs.io/",
     "desc":lazy_gettext("Thrive is building a blockchain-based premium advertising and data marketplace using Origin Protocol.")
    },
    {
    "name":"mobotiq",
    "url":"http://mobotiq.com/",
     "desc":lazy_gettext("Mobotiq is building a decentralized peer-to-peer mobility solution using Origin Protocol and powered by their autonomous pods.")
    },
    {
    "name":"odem",
    "url":"https://odem.io/",
     "desc":lazy_gettext("ODEM is building an in-person education marketplace on the blockchain using Origin Protocol.")
    },
    {
    "name":"brixby",
    "url":"https://www.brixby.io/",
     "desc":lazy_gettext("Brixby is building a peer-to-peer parking marketplace using Origin Protocol to enable businesses to efficiently monetize their unused real estate.")
    },
    {
    "name":"hirematch",
    ...
    "url":"https://workspace0x.com/",
     "desc":lazy_gettext("Workspace0x is a decentralized marketplace for co-working and shared spaces built on Origin Protocol.")
    },
    {
    "name":"cashbag",
    ...
    "name":"craftr",
    "url":"https://craftr.io/",
     "desc":lazy_gettext("CraftR is building their digital marketplace for programmers, designers, and musicians on Origin Protocol.")
    },
    {
    "name":"taskfair",
    "url":"https://taskfair.com/",
     "desc":lazy_gettext("TaskFair is building their jobs marketplace on the blockchain using Origin Protocol.")
    },
    {
    "name":"swipecrypto",
