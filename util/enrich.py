...
print lookup('joshfraz@gmail.com')
# def lookup(email):

#     # url = 'https://api.fullcontact.com/v3/person.enrich'
#     # # headers = {'Authorization':'Bearer ' + constants.FULLCONTACT_KEY}
#     # headers = {'X-FullContact-APIKey': constants.FULLCONTACT_KEY}

#     # print headers

#     # webhook = "https://" + constants.HOST + "/webhook/fullcontact"
...
#     req.add_header('Authorization', 'Bearer '+constants.FULLCONTACT_KEY)
#     data = json.dumps({
